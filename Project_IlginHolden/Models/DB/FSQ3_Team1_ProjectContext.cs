...
{
    public partial class FSQ3_Team1_ProjectContext : DbContext
    {
        public FSQ3_Team1_ProjectContext()
        {
        }

        public FSQ3_Team1_ProjectContext(DbContextOptions<FSQ3_Team1_ProjectContext> options)
            : base(options)
        {
        }
